...
namespace Blog.Service.Migrations
{
    ...
    [Migration("20230509151531_AddName")]
            ...
            modelBuilder.Entity("Blog.Service.Domain.Users.Aggregates.UserInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e18749db-5ff1-498b-93f0-05bbc8561a1e"),
                            Account = "admin",
                            Avatar = "https://blog-simple.oss-cn-shenzhen.aliyuncs.com/Avatar.jpg",
                            CreationTime = new DateTime(2023, 5, 9, 15, 15, 30, 845, DateTimeKind.Utc).AddTicks(8022),
                            Email = "239573049@qq.com",
                            IsDeleted = false,
                            ModificationTime = new DateTime(2023, 5, 9, 15, 15, 30, 845, DateTimeKind.Utc).AddTicks(8026),
                            Name = "Token",
                            Password = "dd666666",
                            Role = "Admin"
                        });
